...
module.exports = class extends Command {
    ...
    async run(message, args, bot, database) {
        ...
        if (links !== message.member.user.tag) return sendErrorMessage(message.channel, `Error: The specified player does not have their discord linked as your discord. Please change your discord from \`${links}\` to \`${message.author.tag}\``);
